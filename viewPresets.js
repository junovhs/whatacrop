...
function createSocialPresets() {
  return `
    ...
    <div class="preset-item" onclick="selectPixelPreset('social','IG Square 1080×1080',1080,1080)">Square 1:1 1080×1080</div>
    <div class="preset-item" onclick="selectPixelPreset('social','IG Portrait 1080×1350',1080,1350)">Portrait 4:5 1080×1350</div>
    <div class="preset-item" onclick="selectPixelPreset('social','IG Landscape 1080×566',1080,566)">Landscape 1080×566</div>
    <div class="preset-item" onclick="selectPixelPreset('social','IG Story 1080×1920',1080,1920)">Story/Reel 1080×1920</div>

    <div class="preset-group-label">Facebook</div>
    <div class="preset-item" onclick="selectPixelPreset('social','FB Link 1200×630',1200,630)">Link 1200×630</div>
    <div class="preset-item" onclick="selectPixelPreset('social','FB Post 1080×1080',1080,1080)">Post 1080×1080</div>
    <div class="preset-item" onclick="selectPixelPreset('social','FB Cover 820×312',820,312)">Cover 820×312</div>

    <div class="preset-group-label">X / Twitter</div>
    <div class="preset-item" onclick="selectPixelPreset('social','X Post 1600×900',1600,900)">Post 1600×900</div>
    <div class="preset-item" onclick="selectPixelPreset('social','X Header 1500×500',1500,500)">Header 1500×500</div>

    <div class="preset-group-label">YouTube</div>
    <div class="preset-item" onclick="selectPixelPreset('social','YT Thumb 1280×720',1280,720)">Thumbnail 1280×720</div>
    <div class="preset-item" onclick="selectPixelPreset('social','YT Frame 1920×1080',1920,1080)">Frame 1920×1080</div>
  `;
}
...
function createDocsPresets() {
  return `
    ...
    <div class="preset-item" onclick="selectPixelPreset('docs','A4 2480×3508',2480,3508)">A4 2480×3508</div>
    <div class="preset-item" onclick="selectPixelPreset('docs','Letter 2550×3300',2550,3300)">Letter 2550×3300</div>
    <div class="preset-item" onclick="selectPixelPreset('docs','A5 1748×2480',1748,2480)">A5 1748×2480</div>
  `;
}
